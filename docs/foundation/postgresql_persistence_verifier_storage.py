...
def validate_bootstrap_sources(migration: dict[str, Any], errors: list[str]) -> None:
    ...
    expected_paths = [
        ...
        "crates/storyos-adapter-postgres/migrations/0016_update_volume.sql",
        "crates/storyos-adapter-postgres/migrations/0017_update_chapter.sql",
        "crates/storyos-adapter-postgres/migrations/0018_manuscript_blocks.sql",
        "crates/storyos-adapter-postgres/migrations/0019_set_current_chapter.sql",
        "crates/storyos-adapter-postgres/migrations/0020_undo_latest_author_action.sql",
        "crates/storyos-adapter-postgres/migrations/0021_delete_chapter.sql",
        "crates/storyos-adapter-postgres/migrations/0022_delete_volume.sql",
        "crates/storyos-adapter-postgres/migrations/0023_export_human_readable_manuscript.sql",
        "crates/storyos-adapter-postgres/migrations/0024_export_project_archive_admission.sql",
        "crates/storyos-adapter-postgres/migrations/0025_export_project_archive_entries.sql",
        "crates/storyos-adapter-postgres/migrations/0026_recovery_visibility_proof.sql",
        "crates/storyos-adapter-postgres/migrations/0027_author_command_admission_reconfirmations.sql",
        "crates/storyos-adapter-postgres/migrations/0028_tree_revision_conflict_names.sql",
        "crates/storyos-adapter-postgres/migrations/0029_human_readable_manuscript_export_operations.sql",
        "crates/storyos-adapter-postgres/migrations/0030_human_readable_export_worker_claim.sql",
        "crates/storyos-adapter-postgres/migrations/0031_project_export_operations.sql",
        ...
        "crates/storyos-adapter-postgres/migrations/0036_release1_storage_activation.sql",
        "crates/storyos-adapter-postgres/migrations/0037_structural_authority_settlement_schema.sql",
        "crates/storyos-adapter-postgres/migrations/0038_create_volume_structure_compensation.sql",
        "crates/storyos-adapter-postgres/migrations/0039_volume_updated_compensation_priors.sql",
        "crates/storyos-adapter-postgres/migrations/0040_chapter_updated_compensation_priors.sql",
        "crates/storyos-adapter-postgres/migrations/0041_chapter_deleted_compensation_priors.sql",
        "crates/storyos-adapter-postgres/migrations/0042_volume_deleted_compensation.sql",
        "crates/storyos-adapter-postgres/migrations/0043_current_chapter_compensation.sql",
        "crates/storyos-adapter-postgres/migrations/0044_command_response_project.sql",
        "crates/storyos-adapter-postgres/migrations/0045_update_project_assistance.sql",
        "crates/storyos-adapter-postgres/migrations/0046_create_agent_run.sql",
        "crates/storyos-adapter-postgres/migrations/0047_context_assembly.sql",
        "crates/storyos-adapter-postgres/migrations/0048_complete_fake_model_decision.sql",
        "crates/storyos-adapter-postgres/migrations/0049_open_block_proposal.sql",
        ...
        "crates/storyos-adapter-postgres/migrations/0054_reject_proposal_operations.sql",
        "crates/storyos-adapter-postgres/migrations/0055_reopen_rejected_operations.sql",
        "crates/storyos-adapter-postgres/migrations/0056_open_inline_proposal.sql",
        "crates/storyos-adapter-postgres/migrations/0057_settle_multi_operation_selections.sql",
        "crates/storyos-adapter-postgres/migrations/0058_stream_proposal_generation.sql",
        "crates/storyos-adapter-postgres/migrations/0059_recover_or_cancel_agent_run.sql",
        "crates/storyos-adapter-postgres/migrations/0060_preserve_archived_export_recovery.sql",
...
def validate_families(catalog: dict[str, Any], route_catalog: dict[str, Any], errors: list[str]) -> tuple[dict[str, dict[str, Any]], dict[str, set[str]], dict[str, set[str]]]:
    ...
    for family in families:
        ...
        actual_activity_profiles = {event_by_id[event_id].get("wire_profile") for event_id in known_referenced_events if event_id not in {"storyos.event.refused-edit-draft-created.v1", "storyos.event.editor-flow-draft-closed.v1", "storyos.event.editor-flow-draft-reopened.v1"}}
