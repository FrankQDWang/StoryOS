...
| `B-REL-005-RELEASE-SET` | Exact Release 1 aggregate for `REL-005`; members are `B-CONTRACT`, `B-SCOPE`, `B-EDITOR`, `B-CORE`, `B-RECOVERY`, `B-REPLAY`, `B-RESTORE`, `B-CONTEXT`, `B-FAKE`, `B-REAL-ADVISORY`, `B-ABSENT`, `B-EVAL`, `B-MEASURE`, and `B-HANDOFF`. |
| `B-S2-JRN-001-EDITOR-RELEASE-SET` | Exact Stage 2 journey aggregate; members are `B-CONTRACT`, `B-SCOPE`, `B-EDITOR`, `B-CORE`, `B-RECOVERY`, `B-REPLAY`, `B-RESTORE`, `B-CONTEXT`, `B-ABSENT`, `B-MEASURE`, and `B-HANDOFF`. |
| `B-S4-REQ-006-AUTHOR-JOURNEY-SET` | Exact `S4-REQ-006` author-journey aggregate; members are `B-SCOPE`, `B-CORE`, `B-RECOVERY`, `B-REPLAY`, `B-RESTORE`, `B-CONTEXT`, `B-REAL-ADVISORY`, `B-ABSENT`, and `B-HANDOFF`. |
| `B-S4-JRN-001-SET` | Exact Stage 4 journey aggregate; members are `B-SCOPE`, `B-CORE`, `B-RECOVERY`, `B-REPLAY`, `B-RESTORE`, `B-CONTEXT`, `B-REAL-ADVISORY`, `B-ABSENT`, and `B-HANDOFF`. |
| `B-HND-003-STAGE-SET` | Exact aggregate for all stage implementation evidence; members are `B-CONTRACT`, `B-SCOPE`, `B-EDITOR`, `B-CORE`, `B-RECOVERY`, `B-REPLAY`, `B-RESTORE`, `B-CONTEXT`, `B-FAKE`, `B-REAL-ADVISORY`, `B-ABSENT`, `B-EVAL`, `B-MEASURE`, and `B-HANDOFF`. |
| `B-HND-004-STAGE-RELEASE-SET` | Exact aggregate for stage release evidence; members are `B-CONTRACT`, `B-SCOPE`, `B-EDITOR`, `B-CORE`, `B-RECOVERY`, `B-REPLAY`, `B-RESTORE`, `B-CONTEXT`, `B-FAKE`, `B-REAL-ADVISORY`, `B-ABSENT`, `B-EVAL`, `B-MEASURE`, and `B-HANDOFF`. |
...
### 11.4 Crosswalk token grammar and aggregate bundle sets
...
| `REL-004` | Exactly four stages and their accepted order remain unchanged; `OWN-REL`, `OWN-STAGE`. | `DVG-01`, `DVG-02`, `DVG-03`, `DVG-04`, `DVG-05`, `DVG-06`, `DVG-07`, `DVG-08`, `DVG-09`, `DVG-10`, `DVG-11`, `DVG-12`, `DVG-13` | `EC-01`; `EV-CP/SE/SR` | `FX-HANDOFF`, `FX-CONTRACT-R1` · contract drift and stage-boundary points · `SCH-DRIFT/NORMAL/ABSENT` · `ORC-CROSSWALK-COMPLETENESS` · `CFP-CONTRACT-DRIFT` | `B-HANDOFF` + `B-CONTRACT`; `PASS-STAGE` when the four-stage sequence and evidence dependency graph match [Define the AI-Independent Editor-First Release Baseline and Handoff Criteria](https://github.com/FrankQDWang/StoryOS/issues/62). | `BLOCK-ALL`; any new stage, reordered stage, invented capability, or unresolved owner/gate row blocks. |
| `REL-005` | A stage is eligible only when its author journey and mandatory evidence are current, attributable, replayable, and passed; `OWN-REL`, `OWN-DVG`. | `DVG-01`, `DVG-02`, `DVG-03`, `DVG-04`, `DVG-05`, `DVG-06`, `DVG-07`, `DVG-08`, `DVG-09`, `DVG-10`, `DVG-11`, `DVG-12`, `DVG-13` | `EC-01/02/03/04/05/06/07/08`; `EV-CP/IT/INT/PRD/RDA/SE/SR` | `FX-CONTRACT-R1`, `FX-HANDOFF`, `FX-SCOPE-2U2P`, `FX-EDITOR-IME`, `FX-JOURNAL-GROUP`, `FX-CORE-PROPOSAL`, `FX-RECOVERY-EDITOR`, `FX-REPLAY-RETENTION`, `FX-RESTORE-LIFECYCLE`, `FX-CONTEXT-DISCLOSURE`, `FX-FAKE-MODEL`, `FX-REAL-MODEL-ADVISORY`, `FX-ABSENT-EXECUTION`, `FX-EVAL-READONLY`, `FX-LONG-SESSION` · `CFP-CONTRACT-DRIFT`, `CFP-SCOPE-BEFORE-QUERY`, `CFP-EDITOR-BEFORE-JOURNAL-DURABILITY`, `CFP-CORE-BEFORE-COMMIT`, `CFP-MANIFEST-BEFORE-COMMIT`, `CFP-DISPATCH-AFTER-IO-BEFORE-CONFIRMATION`, `CFP-FENCE-AFTER-TAKEOVER`, `CFP-REPLAY-BEFORE-COMPACTION`, `CFP-RESTORE-BEFORE-VISIBILITY`, `CFP-LIFECYCLE-AFTER-INVALIDATION-BEFORE-CLEANUP`, `CFP-DELETE-AFTER-SETTLEMENT` · `SCH-DRIFT/NORMAL/REORDER/CRASH/FENCE/REPLAY/RESTORE/LIFECYCLE/SCOPE/UNKNOWN/ABSENT/LONG` · `ORC-CROSSWALK-COMPLETENESS` | `B-REL-005-RELEASE-SET`; `PASS-STAGE` only after all mandatory statuses are `Passed` or the row-specific expected negative/hold disposition. | `BLOCK-ALL`; failed/unrun/stale/unavailable/unverified/unreplayable evidence blocks even if another stage or advisory check is green. |
...
| `S4-REQ-006` | Real author can write/request/inspect/edit/Accept/Reject/recover all StoryOS-owned facts; `OWN-REL`, `OWN-WEB`, `OWN-CORE`, `OWN-ADM`, `OWN-CTX`, `OWN-RET`. | `DVG-02`, `DVG-03`, `DVG-04`, `DVG-05`, `DVG-07`, `DVG-08`, `DVG-10`, `DVG-11`, `DVG-13` | `EC-02/03/04/05/07/08`; `EV-CP/INT/PRD/RDA/SE/SR` | `FX-SCOPE-2U2P`, `FX-CONTEXT-DISCLOSURE`, `FX-REAL-MODEL-ADVISORY`, `FX-CORE-PROPOSAL`, `FX-RECOVERY-EDITOR`, `FX-REPLAY-RETENTION`, `FX-RESTORE-LIFECYCLE`, `FX-ABSENT-EXECUTION` · `CFP-SCOPE-BEFORE-QUERY`, `CFP-MANIFEST-BEFORE-COMMIT`, `CFP-MANIFEST-AFTER-COMMIT-BEFORE-EGRESS`, `CFP-DISPATCH-AFTER-CLAIM-BEFORE-IO`, `CFP-DISPATCH-AFTER-IO-BEFORE-CONFIRMATION`, `CFP-RECONCILIATION-BEFORE-SETTLEMENT`, `CFP-PROPOSAL-BEFORE-DECISION`, `CFP-CORE-AFTER-COMMIT-BEFORE-ACK`, `CFP-FENCE-AFTER-TAKEOVER`, `CFP-REPLAY-BELOW-FLOOR`, `CFP-RESTORE-BEFORE-VISIBILITY`, `CFP-RESTORE-AFTER-VISIBILITY`, `CFP-LIFECYCLE-AFTER-INVALIDATION-BEFORE-CLEANUP` · `SCH-NORMAL/UNKNOWN/CRASH/FENCE/RESTORE/REPLAY/SCOPE/LIFECYCLE` · `ORC-ATOMIC-AUTHORITY`, `ORC-RECOVERY-ATOMICITY`, `ORC-RESTORE-LIFECYCLE`, `ORC-OUTCOME-UNKNOWN` · `CFP-EDITOR-AFTER-SETTLEMENT-BEFORE-ACK` | `B-S4-REQ-006-AUTHOR-JOURNEY-SET`; `PASS-STAGE` after S4 journey and mandatory evidence. | `BLOCK-ALL`; any uninspectable fact, missing decision, recovery gap, or Provider claim substituted for StoryOS evidence blocks. |
...
| `S4-JRN-001` | Seven-step Stage 4 journey—standalone editor, bounded request, pre-egress manifest, edit/accept/reject, post-dispatch unknown, reconciliation/recovery, model-disabled S2 repeat—is executable; `OWN-REL` and all Stage 4 owners. | `DVG-01`, `DVG-02`, `DVG-03`, `DVG-04`, `DVG-05`, `DVG-07`, `DVG-08`, `DVG-09`, `DVG-10`, `DVG-11`, `DVG-13` | `EC-01/02/03/04/05/07/08`; `EV-CP/INT/PRD/RDA/SE/SR` | `FX-SCOPE-2U2P`, `FX-CONTEXT-DISCLOSURE`, `FX-REAL-MODEL-ADVISORY`, `FX-CORE-PROPOSAL`, `FX-RECOVERY-EDITOR`, `FX-REPLAY-RETENTION`, `FX-RESTORE-LIFECYCLE`, `FX-ABSENT-EXECUTION` · `CFP-SCOPE-BEFORE-QUERY`, `CFP-MANIFEST-BEFORE-COMMIT`, `CFP-MANIFEST-AFTER-COMMIT-BEFORE-EGRESS`, `CFP-DISPATCH-AFTER-CLAIM-BEFORE-IO`, `CFP-RECONCILIATION-BEFORE-SETTLEMENT`, `CFP-PROPOSAL-BEFORE-DECISION`, `CFP-CORE-AFTER-COMMIT-BEFORE-ACK`, `CFP-FENCE-AFTER-TAKEOVER`, `CFP-REPLAY-BELOW-FLOOR`, `CFP-RESTORE-BEFORE-VISIBILITY`, `CFP-RESTORE-AFTER-VISIBILITY`, `CFP-LIFECYCLE-AFTER-INVALIDATION-BEFORE-CLEANUP` · `SCH-NORMAL/UNKNOWN/CRASH/FENCE/RESTORE/SCOPE/REPLAY/ABSENT/LIFECYCLE` · `ORC-CROSSWALK-COMPLETENESS`, `ORC-OUTCOME-UNKNOWN`, `ORC-NEGATIVE-CLOSURE` · `CFP-DISPATCH-AFTER-IO-BEFORE-CONFIRMATION` | `B-S4-JRN-001-SET`; `PASS-STAGE`. | `BLOCK-ALL`; any missing manifest, unknown recovery, author decision, S2 repeat, or absent-capability refusal blocks Stage 4. |
...
| `HND-002` | Implementation handoff is exactly one bounded Stage 1 issue after [Define Deterministic Verification and Failure-Recovery Gates](https://github.com/FrankQDWang/StoryOS/issues/60); no implementation is hidden in this contract; `OWN-REL`, `OWN-GOV`, `OWN-STAGE`. | `DVG-01`, `DVG-02`, `DVG-03`, `DVG-09`, `DVG-10`, `DVG-11`, `DVG-13` | `EC-01/02/03/04/05`; `EV-CP/SE` | `FX-HANDOFF`, `FX-CONTRACT-R1` · source/drift/scope/core/recovery/lifecycle points · `SCH-DRIFT/NORMAL/ABSENT` · `ORC-CROSSWALK-COMPLETENESS` · `CFP-CONTRACT-DRIFT` | `B-HANDOFF`; `PASS-STAGE` for a bounded handoff record only. | `BLOCK-ALL`; an unbounded implementation scope, extra issue, or product change blocks. |
| `HND-003` | Stage implementation evidence is complete, attributable to the exact baseline, and covers every listed gate; `OWN-REL` with each stage owner. | `DVG-01`, `DVG-02`, `DVG-03`, `DVG-04`, `DVG-05`, `DVG-06`, `DVG-07`, `DVG-08`, `DVG-09`, `DVG-10`, `DVG-11`, `DVG-12`, `DVG-13` | `EC-01/02/03/04/05/06/07/08`; `EV-CP/IT/INT/PRD/RDA/SE` | `FX-HANDOFF` · `SCH-DRIFT/NORMAL/REORDER/CRASH/FENCE/REPLAY/RESTORE/LIFECYCLE/SCOPE/UNKNOWN/ABSENT/LONG` · `ORC-CONTRACT`, `ORC-SCOPE`, `ORC-EDITOR-JOURNAL`, `ORC-ATOMIC-AUTHORITY`, `ORC-CONTEXT-DISCLOSURE`, `ORC-DISPATCH-DISCLOSURE`, `ORC-RUN-FINALIZATION`, `ORC-RECOVERY-ATOMICITY`, `ORC-OUTCOME-UNKNOWN`, `ORC-REPLAY-TRUTH`, `ORC-RESTORE-LIFECYCLE`, `ORC-NEGATIVE-CLOSURE`, `ORC-EVAL-READONLY`, `ORC-CROSSWALK-COMPLETENESS` · `CFP-CONTRACT-DRIFT` | `B-HND-003-STAGE-SET`; `PASS-STAGE`. | `BLOCK-ALL`; one missing/stale/unreplayable mandatory bundle blocks. |
| `HND-004` | Stage release requires author journey plus mandatory pass and records the resulting main/next input; `OWN-REL`, `OWN-STAGE`. | `DVG-01`, `DVG-02`, `DVG-03`, `DVG-04`, `DVG-05`, `DVG-06`, `DVG-07`, `DVG-08`, `DVG-09`, `DVG-10`, `DVG-11`, `DVG-12`, `DVG-13` | `EC-01/02/03/04/05/06/07/08`; `EV-INT/PRD/SE/SR` | `FX-CONTRACT-R1`, `FX-HANDOFF`, `FX-EDITOR-IME`, `FX-RECOVERY-EDITOR`, `FX-REPLAY-RETENTION`, `FX-RESTORE-LIFECYCLE`, `FX-CONTEXT-DISCLOSURE`, `FX-CORE-PROPOSAL`, `FX-FAKE-MODEL`, `FX-REAL-MODEL-ADVISORY`, `FX-ABSENT-EXECUTION` · `SCH-DRIFT/NORMAL/REORDER/CRASH/FENCE/REPLAY/RESTORE/LIFECYCLE/SCOPE/UNKNOWN/ABSENT/LONG` · `ORC-CROSSWALK-COMPLETENESS` · `CFP-CONTRACT-DRIFT` | `B-HND-004-STAGE-RELEASE-SET`; `PASS-STAGE`. | `BLOCK-ALL`; passing gates without journey, or journey without mandatory pass, is not release. |
