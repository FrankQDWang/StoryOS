...
| [Record the Deferred Eval Observation Boundary](https://github.com/FrankQDWang/StoryOS/issues/61) | Future observation surface outside MVP; no current API or schema handoff | Deferred scope only; no datasets, scoring, or assessment requirement |
