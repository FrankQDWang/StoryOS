...
_Avoid_: Provider, second author-facing route, Host Internal Processing, Core shortcut mock, direct Agent Decision injection, bypassed manifest, fake as authority, fake as no-disclosure, received-by-provider claim
