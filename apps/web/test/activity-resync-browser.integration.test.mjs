...
import { openEditorWorkspace, persistReplaceSelection } from "/apps/web/src/editor-session.ts";
import { readJournalSnapshot, rebuildPendingProjection } from "/apps/web/src/local-edit-journal.ts";
import {
  ingestProjectActivityFrames, readProjectActivityIngest, resyncProjectActivityFromSnapshot,
} from "/apps/web/src/project-activity-ingest.ts";
...
test("resync after a new Snapshot generation preserves payload and resumes after that position", {
  ...
  const allowed = new Set([
    ...
    "/apps/web/src/project-activity-ingest.ts",
