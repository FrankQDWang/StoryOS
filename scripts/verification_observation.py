...
FIELDS = ('run_id', 'id', 'issue', 'pr', 'profile', 'status', 'stage', 'parent',
          ...
          'repository', 'retry_reason', 'requested_scope', 'complete_dispatch_attempt', 'build_state', 'blocked_clock', 'blocked_intervals', 'ended_monotonic', 'attempt_started', 'actual_started_at', 'outcome', 'utc', 'recovery_of')
...
def read_record(path, records):
    ...
    try:
        ...
        fingerprint = '750:' + hashlib.sha256(raw).hexdigest()
