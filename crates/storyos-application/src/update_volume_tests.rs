...
fn command() -> UpdateVolumeCommand {
    ...
    UpdateVolumeCommand {
        ...
        challenge_binding: ProjectCommandChallengeBinding {
            ...
            canonical_command_digest: "sha256:storyos.command.updateVolume.jcs.v1:17a3ea88f6cd664a678f2e13c8fb405209d3ba8c4efe16964980f1199f4449c8".to_owned(),
            idempotency_key: "key".to_owned(),
        },
        nonce_digest: "nonce".to_owned(),
        canonical_command_bytes:
            br#"{"expected_tree_revision":"2","order":"2","title":"Volume B"}"#.to_vec(),
