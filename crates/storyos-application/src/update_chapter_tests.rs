...
fn command() -> UpdateChapterCommand {
    ...
    UpdateChapterCommand {
        ...
        challenge_binding: ProjectCommandChallengeBinding {
            ...
            canonical_command_digest: "sha256:storyos.command.updateChapter.jcs.v1:26ab6857e31323624a16d09b0d5ce9c6a9568e7f5d390187729db7c795389022".to_owned(),
            idempotency_key: "key".to_owned(),
        },
        nonce_digest: "nonce".to_owned(),
        canonical_command_bytes:
            br#"{"expected_chapter_revision":"2","order":"2","title":"Chapter B"}"#.to_vec(),
