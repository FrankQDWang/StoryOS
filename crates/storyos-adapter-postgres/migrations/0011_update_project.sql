...
GRANT UPDATE ON storyos.projects TO storyos_runtime;
...
FOR EACH ROW
WHEN (NEW.command_kind NOT IN ('createProject', 'updateProject'))
...
ALTER TABLE storyos.domain_receipts
  ADD CONSTRAINT domain_receipts_common_shape CHECK ((
    ...
    AND (
      (command_kind NOT IN ('createProject', 'updateProject')
      ...
      OR (command_kind IN ('createProject', 'updateProject')
