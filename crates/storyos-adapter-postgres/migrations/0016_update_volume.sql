...
GRANT UPDATE ON storyos.manuscript_objects TO storyos_runtime;
...
ALTER TABLE storyos.domain_receipts
  ...
  CHECK (command_kind IN (
    ...
    'archiveProject', 'createVolume', 'createChapter', 'updateVolume'
  ));
...
ALTER TABLE storyos.project_activity_event_payloads
  ...
  CHECK (event_kind IN (
    ...
    'volume_created', 'volume_updated', 'chapter_created'
  ));
