...
use crate::release1_archive_project::{
    ARCHIVE_PROJECT, ARCHIVE_PROJECT_DIGEST_PROFILE, ARCHIVE_PROJECT_REQUEST_SCHEMA_ID,
    ARCHIVE_PROJECT_RESPONSE_SCHEMA_ID, ArchiveProjectConflictReason, ArchiveProjectEffect,
    ArchiveProjectInput, ArchiveProjectNoEffectReason, ArchiveProjectRequest,
    ArchiveProjectResponse,
};

pub(super) const REQUEST_SCHEMA_PATH: &str =
    "generated/json-schema/storyos-public-release-1/archive-project-request.schema.json";
pub(super) const RESPONSE_SCHEMA_PATH: &str =
    "generated/json-schema/storyos-public-release-1/archive-project-response.schema.json";
pub(super) const FIXTURE_PATHS: [&str; 3] = [
    "generated/golden-wire/storyos-public-release-1/archive-project.json",
    "generated/golden-wire/storyos-public-release-1/archive-project.invalid.json",
    "generated/golden-wire/storyos-public-release-1/archive-project.boundary.json",
];
...
pub(super) fn request_schema_bytes() -> Vec<u8> {
    let mut schema = schema_value::<ArchiveProjectRequest>(
        ARCHIVE_PROJECT_REQUEST_SCHEMA_ID,
        "StoryOS Archive Project Request",
    );
    schema["properties"]["command_schema"]["const"] = json!(ARCHIVE_PROJECT_REQUEST_SCHEMA_ID);
    let input = &mut schema["$defs"]["ArchiveProjectInput"]["properties"];
...
pub(super) fn response_schema_bytes() -> Vec<u8> {
    let mut schema = schema_value::<ArchiveProjectResponse>(
        ARCHIVE_PROJECT_RESPONSE_SCHEMA_ID,
        "StoryOS Archive Project Response",
    );
    schema["properties"]["schema_id"]["const"] = json!(ARCHIVE_PROJECT_RESPONSE_SCHEMA_ID);
...
pub(super) fn typescript_type_declarations() -> String {
    ...
    format!(
        "export {}\n\nexport {}\n\nexport {}\n\nexport {}\n\nexport {}\n\nexport {}",
        ArchiveProjectInput::decl(&config),
        ArchiveProjectRequest::decl(&config),
        ArchiveProjectNoEffectReason::decl(&config),
        ArchiveProjectConflictReason::decl(&config),
        ArchiveProjectEffect::decl(&config),
        ArchiveProjectResponse::decl(&config),
    )
}
...
pub(super) fn typescript_client_source() -> String {
    format!(
        ...
        ARCHIVE_PROJECT_DIGEST_PROFILE,
        ARCHIVE_PROJECT
            .path
...
pub(super) fn fixture_bytes() -> Vec<u8> {
    json_bytes(&command_fixture("2026-08-25T14:05:00.000Z"))
}

pub(super) fn invalid_fixture_bytes() -> Vec<u8> {
    let mut value = command_fixture("2026-08-25T14:05:00.000Z");
    value
        .as_object_mut()
...
fn command_fixture(created_at: &str) -> Value {
    json!({
        "schema_id": ARCHIVE_PROJECT_RESPONSE_SCHEMA_ID,
        ...
        "receipt": {
            ...
            "command_digest": {
                "algorithm": "sha256",
                "profile": ARCHIVE_PROJECT_DIGEST_PROFILE,
