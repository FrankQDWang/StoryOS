#[test]
fn proposal_wire_is_generated_from_one_closed_contract() {
    let operation = &crate::release1_proposal::GET_PROPOSAL;
    ...
    assert!(openapi.contains("operationId: getProposal"));
    ...
    assert!(client.contains("export async function getProposal("));
}
