...
#[test]
fn release_profile_module_has_a_generated_declaration_in_the_typescript_digest() {
    let generated = super::generated_files()
        .into_iter()
        .collect::<std::collections::BTreeMap<_, _>>();
    let client = &generated["generated/typescript/storyos-public-release-1/client.mjs"];
    let client_declaration =
        &generated["generated/typescript/storyos-public-release-1/client.d.mts"];
    let profile_declaration = generated
        .get("generated/typescript/storyos-public-release-1/release-profile.d.mts")
        .expect("the generated release profile must have a declaration");
    assert_eq!(
        profile_declaration,
    ...
    assert_eq!(
        release1_protocol_profile()
            .release_identity
            .typescript_artifact_digest,
        sha256_prefixed(typescript)
    );
}
