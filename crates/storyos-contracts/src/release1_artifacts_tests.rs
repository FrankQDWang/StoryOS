...
fn author_edit_response_v2_keeps_activity_only_on_the_applied_variant() {
    ...
    assert_eq!(
        ...
        "storyos.typescript-client.release-1.v13"
    );
    ...
    assert!(generated_client.contains(
        "export const GENERATED_CLIENT_REVISION = \"storyos.typescript-client.release-1.v13\";"
    ));
