...
pub(super) const REQUEST_SCHEMA_PATH: &str =
    "generated/json-schema/storyos-public-release-1/create-chapter-request.schema.json";
pub(super) const RESPONSE_SCHEMA_PATH: &str =
    "generated/json-schema/storyos-public-release-1/create-chapter-response.schema.json";
pub(super) const FIXTURE_PATHS: [&str; 3] = [
    "generated/golden-wire/storyos-public-release-1/create-chapter.json",
    "generated/golden-wire/storyos-public-release-1/create-chapter.invalid.json",
    "generated/golden-wire/storyos-public-release-1/create-chapter.boundary.json",
];
...
pub(super) fn request_schema_bytes() -> Vec<u8> {
    let mut schema = schema_value::<CreateChapterRequest>(
        CREATE_CHAPTER_REQUEST_SCHEMA_ID,
        "StoryOS Create Chapter Request",
    );
    schema["properties"]["command_schema"]["const"] = json!(CREATE_CHAPTER_REQUEST_SCHEMA_ID);
...
pub(super) fn response_schema_bytes() -> Vec<u8> {
    let mut schema = schema_value::<CreateChapterResponse>(
        CREATE_CHAPTER_RESPONSE_SCHEMA_ID,
        "StoryOS Create Chapter Response",
    );
    schema["properties"]["schema_id"]["const"] = json!(CREATE_CHAPTER_RESPONSE_SCHEMA_ID);
...
pub(super) fn typescript_type_declarations() -> String {
    ...
    format!(
        ...
        CreateChapterRefusalReason::decl(&config),
        CreateChapterEffect::decl(&config),
        CreateChapterResponse::decl(&config),
    )
}
...
fn command_fixture(created_at: &str) -> Value {
    json!({
        "schema_id": CREATE_CHAPTER_RESPONSE_SCHEMA_ID,
        ...
        "receipt": {
            ...
            "command_digest": {
                "algorithm": "sha256",
                "profile": CREATE_CHAPTER_DIGEST_PROFILE,
        ...
        "effect": {
            ...
            "chapter_id": "018f0000-0000-7001-8000-000000000916",
            "title": "Chapter A",
            "tree_revision": "3",
            "order": "1",
            "current_chapter_id": "018f0000-0000-7001-8000-000000000916",
