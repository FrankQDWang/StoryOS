...
pub(super) const SERVER_CONTRACT_REVISION: &str = "storyos.server.release-1.v4";
pub(super) const WORKER_CONTRACT_REVISION: &str = "storyos.worker.release-1.v4";
pub(super) const GENERATED_CLIENT_REVISION: &str = "storyos.typescript-client.release-1.v19";
