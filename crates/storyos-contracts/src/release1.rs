...
pub const PUBLIC_PROTOCOL_RELEASE: &str = "storyos.public.release.1";
...
pub(super) const CONTRACT_REVISION: &str = "release1-wire-catalog-2026-09-26-refused-edit-discard";
pub(super) const WEB_CLIENT_CONTRACT_REVISION: &str = "storyos.web-client.release-1.v3";
pub(super) const SERVER_CONTRACT_REVISION: &str = "storyos.server.release-1.v7";
pub(super) const WORKER_CONTRACT_REVISION: &str = "storyos.worker.release-1.v6";
pub(super) const GENERATED_CLIENT_REVISION: &str = "storyos.typescript-client.release-1.v25";
