...
const REVIEW_CATALOG_SHA256: &str =
    "sha256:4bd045d6acda2a077a16c4cdb3a7435343aed061a8dbc6f9138a73010a29ac52";
const REVIEWED_CONTRACT_GRAPH_SHA256: &str =
    "sha256:c769f88e1597d1c176fecd84a0ae7b8ddee785be39fffa8561694593f8a65f48";
...
fn generated_files() -> Vec<GeneratedFile> {
    ...
    generated.extend([
        ...
        (
            create_project_artifacts::FIXTURE_PATHS[0],
            create_project_artifacts::fixture_bytes(),
        ),
        (
            create_project_artifacts::FIXTURE_PATHS[1],
            create_project_artifacts::invalid_fixture_bytes(),
        ),
        (
            create_project_artifacts::FIXTURE_PATHS[2],
            create_project_artifacts::boundary_fixture_bytes(),
        ),
        (
            list_projects_artifacts::FIXTURE_PATHS[0],
            list_projects_artifacts::fixture_bytes(),
        ),
        (
            list_projects_artifacts::FIXTURE_PATHS[1],
            list_projects_artifacts::invalid_fixture_bytes(),
        ),
        (
            list_projects_artifacts::FIXTURE_PATHS[2],
            list_projects_artifacts::boundary_fixture_bytes(),
        ),
        (
            manuscript_tree_artifacts::FIXTURE_PATHS[0],
            manuscript_tree_artifacts::fixture_bytes(),
        ),
        (
            manuscript_tree_artifacts::FIXTURE_PATHS[1],
            manuscript_tree_artifacts::invalid_fixture_bytes(),
        ),
        (
            manuscript_tree_artifacts::FIXTURE_PATHS[2],
        ...
        (
            readable_export_artifacts::FIXTURE_PATHS[0],
            readable_export_artifacts::fixture_bytes(),
        ),
        (
            readable_export_artifacts::FIXTURE_PATHS[1],
            readable_export_artifacts::invalid_fixture_bytes(),
        ),
        (
            readable_export_artifacts::FIXTURE_PATHS[2],
            readable_export_artifacts::boundary_fixture_bytes(),
        ),
        (
            readable_export_query_artifacts::FIXTURE_PATHS[0],
            readable_export_query_artifacts::fixture_bytes(),
        ),
        (
            readable_export_query_artifacts::FIXTURE_PATHS[1],
            readable_export_query_artifacts::invalid_fixture_bytes(),
        ),
        (
            readable_export_query_artifacts::FIXTURE_PATHS[2],
        ...
        (
            update_project_artifacts::FIXTURE_PATHS[1],
            update_project_artifacts::invalid_fixture_bytes(),
        ),
        (
            update_project_artifacts::FIXTURE_PATHS[2],
            update_project_artifacts::boundary_fixture_bytes(),
        ),
        (
            archive_project_artifacts::FIXTURE_PATHS[0],
            archive_project_artifacts::fixture_bytes(),
        ),
        (
            archive_project_artifacts::FIXTURE_PATHS[1],
            archive_project_artifacts::invalid_fixture_bytes(),
        ),
        (
            archive_project_artifacts::FIXTURE_PATHS[2],
            archive_project_artifacts::boundary_fixture_bytes(),
        ),
        (
            create_volume_artifacts::FIXTURE_PATHS[0],
            create_volume_artifacts::fixture_bytes(),
        ),
        (
            create_volume_artifacts::FIXTURE_PATHS[1],
            create_volume_artifacts::invalid_fixture_bytes(),
        ),
        (
            create_volume_artifacts::FIXTURE_PATHS[2],
            create_volume_artifacts::boundary_fixture_bytes(),
        ),
        (
            update_volume_artifacts::FIXTURE_PATHS[0],
            update_volume_artifacts::fixture_bytes(),
        ),
        (
            update_volume_artifacts::FIXTURE_PATHS[1],
            update_volume_artifacts::invalid_fixture_bytes(),
        ),
        (
            update_volume_artifacts::FIXTURE_PATHS[2],
        ...
        (
            delete_chapter_artifacts::FIXTURE_PATHS[0],
            delete_chapter_artifacts::fixture_bytes(),
        ),
        (
            delete_chapter_artifacts::FIXTURE_PATHS[1],
            delete_chapter_artifacts::invalid_fixture_bytes(),
        ),
        (
            delete_chapter_artifacts::FIXTURE_PATHS[2],
            delete_chapter_artifacts::boundary_fixture_bytes(),
        ),
        (
        ...
        (
            create_chapter_artifacts::FIXTURE_PATHS[1],
            create_chapter_artifacts::invalid_fixture_bytes(),
        ),
        (
            create_chapter_artifacts::FIXTURE_PATHS[2],
            create_chapter_artifacts::boundary_fixture_bytes(),
        ),
        (
            set_current_chapter_artifacts::FIXTURE_PATHS[0],
            set_current_chapter_artifacts::fixture_bytes(),
        ),
        (
            set_current_chapter_artifacts::FIXTURE_PATHS[1],
            set_current_chapter_artifacts::invalid_fixture_bytes(),
        ),
        (
            set_current_chapter_artifacts::FIXTURE_PATHS[2],
            set_current_chapter_artifacts::boundary_fixture_bytes(),
        ),
        (
            undo_latest_author_action_artifacts::FIXTURE_PATHS[0],
            undo_latest_author_action_artifacts::fixture_bytes(),
        ),
        (
            undo_latest_author_action_artifacts::FIXTURE_PATHS[1],
            undo_latest_author_action_artifacts::invalid_fixture_bytes(),
        ),
        (
            undo_latest_author_action_artifacts::FIXTURE_PATHS[2],
            undo_latest_author_action_artifacts::boundary_fixture_bytes(),
        ),
        (
    ...
    json_bytes(&json!({
        ...
        "digest_scope": {
            "paths": [GOLDEN_PROFILE_PATH, INVALID_PROFILE_PATH, BOUNDARY_PROFILE_PATH,
                ...
                set_current_chapter_artifacts::FIXTURE_PATHS[0], set_current_chapter_artifacts::FIXTURE_PATHS[1], set_current_chapter_artifacts::FIXTURE_PATHS[2],
                undo_latest_author_action_artifacts::FIXTURE_PATHS[0], undo_latest_author_action_artifacts::FIXTURE_PATHS[1], undo_latest_author_action_artifacts::FIXTURE_PATHS[2],
        ...
        "fixtures": [
            ...
            {"fixture_id": CREATE_PROJECT.fixtures[0], "classification": "positive", "operation_id": CREATE_PROJECT.operation_id, "path": create_project_artifacts::FIXTURE_PATHS[0]},
            {"fixture_id": CREATE_PROJECT.fixtures[1], "classification": "invalid", "operation_id": CREATE_PROJECT.operation_id, "path": create_project_artifacts::FIXTURE_PATHS[1]},
            {"fixture_id": CREATE_PROJECT.fixtures[2], "classification": "boundary", "operation_id": CREATE_PROJECT.operation_id, "path": create_project_artifacts::FIXTURE_PATHS[2]},
            {"fixture_id": LIST_PROJECTS.fixtures[0], "classification": "positive", "operation_id": LIST_PROJECTS.operation_id, "path": list_projects_artifacts::FIXTURE_PATHS[0]},
            {"fixture_id": LIST_PROJECTS.fixtures[1], "classification": "invalid", "operation_id": LIST_PROJECTS.operation_id, "path": list_projects_artifacts::FIXTURE_PATHS[1]},
            {"fixture_id": LIST_PROJECTS.fixtures[2], "classification": "boundary", "operation_id": LIST_PROJECTS.operation_id, "path": list_projects_artifacts::FIXTURE_PATHS[2]},
            ...
            {"fixture_id": EXPORT_HUMAN_READABLE_MANUSCRIPT.fixtures[0], "classification": "positive", "operation_id": EXPORT_HUMAN_READABLE_MANUSCRIPT.operation_id, "path": readable_export_artifacts::FIXTURE_PATHS[0]},
            {"fixture_id": EXPORT_HUMAN_READABLE_MANUSCRIPT.fixtures[1], "classification": "invalid", "operation_id": EXPORT_HUMAN_READABLE_MANUSCRIPT.operation_id, "path": readable_export_artifacts::FIXTURE_PATHS[1]},
            {"fixture_id": EXPORT_HUMAN_READABLE_MANUSCRIPT.fixtures[2], "classification": "boundary", "operation_id": EXPORT_HUMAN_READABLE_MANUSCRIPT.operation_id, "path": readable_export_artifacts::FIXTURE_PATHS[2]},
            ...
            {"fixture_id": ARCHIVE_PROJECT.fixtures[0], "classification": "positive", "operation_id": ARCHIVE_PROJECT.operation_id, "path": archive_project_artifacts::FIXTURE_PATHS[0]},
            {"fixture_id": ARCHIVE_PROJECT.fixtures[1], "classification": "invalid", "operation_id": ARCHIVE_PROJECT.operation_id, "path": archive_project_artifacts::FIXTURE_PATHS[1]},
            {"fixture_id": ARCHIVE_PROJECT.fixtures[2], "classification": "boundary", "operation_id": ARCHIVE_PROJECT.operation_id, "path": archive_project_artifacts::FIXTURE_PATHS[2]},
            {"fixture_id": CREATE_VOLUME.fixtures[0], "classification": "positive", "operation_id": CREATE_VOLUME.operation_id, "path": create_volume_artifacts::FIXTURE_PATHS[0]},
            {"fixture_id": CREATE_VOLUME.fixtures[1], "classification": "invalid", "operation_id": CREATE_VOLUME.operation_id, "path": create_volume_artifacts::FIXTURE_PATHS[1]},
            {"fixture_id": CREATE_VOLUME.fixtures[2], "classification": "boundary", "operation_id": CREATE_VOLUME.operation_id, "path": create_volume_artifacts::FIXTURE_PATHS[2]},
            ...
            {"fixture_id": DELETE_CHAPTER.fixtures[0], "classification": "positive", "operation_id": DELETE_CHAPTER.operation_id, "path": delete_chapter_artifacts::FIXTURE_PATHS[0]},
            {"fixture_id": DELETE_CHAPTER.fixtures[1], "classification": "invalid", "operation_id": DELETE_CHAPTER.operation_id, "path": delete_chapter_artifacts::FIXTURE_PATHS[1]},
            {"fixture_id": DELETE_CHAPTER.fixtures[2], "classification": "boundary", "operation_id": DELETE_CHAPTER.operation_id, "path": delete_chapter_artifacts::FIXTURE_PATHS[2]},
            {"fixture_id": SET_CURRENT_CHAPTER.fixtures[0], "classification": "positive", "operation_id": SET_CURRENT_CHAPTER.operation_id, "path": set_current_chapter_artifacts::FIXTURE_PATHS[0]},
            {"fixture_id": SET_CURRENT_CHAPTER.fixtures[1], "classification": "invalid", "operation_id": SET_CURRENT_CHAPTER.operation_id, "path": set_current_chapter_artifacts::FIXTURE_PATHS[1]},
            {"fixture_id": SET_CURRENT_CHAPTER.fixtures[2], "classification": "boundary", "operation_id": SET_CURRENT_CHAPTER.operation_id, "path": set_current_chapter_artifacts::FIXTURE_PATHS[2]},
            {"fixture_id": UNDO_LATEST_AUTHOR_ACTION.fixtures[0], "classification": "positive", "operation_id": UNDO_LATEST_AUTHOR_ACTION.operation_id, "path": undo_latest_author_action_artifacts::FIXTURE_PATHS[0]},
            {"fixture_id": UNDO_LATEST_AUTHOR_ACTION.fixtures[1], "classification": "invalid", "operation_id": UNDO_LATEST_AUTHOR_ACTION.operation_id, "path": undo_latest_author_action_artifacts::FIXTURE_PATHS[1]},
            {"fixture_id": UNDO_LATEST_AUTHOR_ACTION.fixtures[2], "classification": "boundary", "operation_id": UNDO_LATEST_AUTHOR_ACTION.operation_id, "path": undo_latest_author_action_artifacts::FIXTURE_PATHS[2]},
