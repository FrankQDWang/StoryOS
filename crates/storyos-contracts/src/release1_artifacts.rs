...
// Keep this small generator beside the digest and output list that own it. Issue #209 limits
// generator changes to this module, so extracting it would create an unauthorized production seam.
